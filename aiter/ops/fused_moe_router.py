...
# still hold a baked pointer to. Keying on the stream pointer is safe: two live
# streams cannot share an address, and a pointer reused after its stream is
# destroyed only re-serves scratch nothing is still reading.
@functools.cache
